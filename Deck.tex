...
\begin{document}
  ...
  \begin{itemize}
    \item<1-> About me
    \begin{itemize}
      \item DevOps engineer @ GAT since 2016
      \item IT professional since 2011
      \item First time event speaker
    \end{itemize}
    \bigskip
    \item<2-> About this presentation
    \begin{itemize}
      \item Quick introduction
      \item Technology stack
      \item The migration and what went wrong
    \end{itemize}
    \bigskip
    \item<3-> Things are moving fast!
  \end{itemize}
  \end{frame}
